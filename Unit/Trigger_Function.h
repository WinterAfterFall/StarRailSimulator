...
class TriggerHealing : public TriggerFunc{
    ...
    TriggerHealing(int priority ,Ally* ptr,function<void(Ally *ptr,Sub_Unit *Healer,Sub_Unit *target,double Value)> Call) 
    : TriggerFunc(priority,ptr) ,Call(Call){}
};
class TriggerDecreaseHP : public TriggerFunc{
    public:
    function<void(Ally *ptr,Unit *Trigger,Sub_Unit *target,double Value)> Call;
    TriggerDecreaseHP(int priority ,Ally* ptr,function<void(Ally *ptr,Unit *Trigger,Sub_Unit *target,double Value)> Call) 
    : TriggerFunc(priority,ptr) ,Call(Call){}
};
