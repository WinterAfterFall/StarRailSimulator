...
void Setup(){
    ...
    sort(BeforeAttack_List.begin(), BeforeAttackAction_List.end(), TriggerFunc::Trigger_cmp);
    sort(AfterAttack_List.begin(), AfterAttackActionList.end(), TriggerFunc::Trigger_cmp);
