...
namespace TemplateName{
    ...
    void Setup(int num ,int E,function<void(Ally *ptr)> LC,function<void(Ally *ptr)> Relic,function<void(Ally *ptr)> Planar){
        ...
        // SetAllyBasicStats(Ally_unit[num].get(),102,350,350,E,ElementType::Lightning,"Remembrance",num,"Aglaea",TYPE_STD);
        ...
        // SetMemoStats(Ally_unit[num].get(),66,35,ElementType::Lightning,"Garmentmaker","Memosprite");
