...
int main(){
    ...
    Mydei::Setup(1,Destruction_Lightcone::Mydei_LC(1),Relic::Scholar,Planar::Bone_Collection);
    ...
    Cipher::Setup(0,Nihility_Lightcone::Before_the_Tutorial(5),Relic::PairSet(ST_SPD_P,ST_SPD_P),Planar::Lushaka);
