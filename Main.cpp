...
int main(){
    ...
    //Dot
    Hysilens::Setup(0,Nihility_Lightcone::ShowTime(5),Relic::PairSet(PairSetType::ATK,PairSetType::ATK),Planar::Lushaka);
    ...
    Char1->enableCheckDamageFormula(DmgFormulaMode::Mtgt); 
