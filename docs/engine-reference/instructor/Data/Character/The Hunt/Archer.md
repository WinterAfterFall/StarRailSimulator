...
kit อ้างอิง: `docs/character-kit-reference/Archer.md` · **ตัวละคร collab (ชุดเดียวกับ `../Destruction/Saber.md`)** · ตัวเดียวของ path `The Hunt` ในโปรเจกต์ · เป็นตัวที่ 2 ที่แก้ `Max_sp` (อีกตัวคือ `../Harmony/Hanabi.md`)
