...
kit อ้างอิง: `docs/character-kit-reference/Gallagher.md` · **ไฟล์อ้างอิงของ "stat ที่คำนวณจาก stat อื่นแบบ live"** (A2: Outgoing Healing = 50% ของ Break Effect) — กลไกนี้ไม่มีในตัวละครอื่นที่สำรวจมา · คู่กับ `Luocha.md` สำหรับระบบฮีลพื้นฐาน
