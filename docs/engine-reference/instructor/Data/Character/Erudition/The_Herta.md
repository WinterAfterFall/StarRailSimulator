...
kit อ้างอิง: `docs/character-kit-reference/The_Herta.md` · **ไฟล์ที่ซับซ้อนที่สุดในกลุ่มที่สำรวจแล้ว (320 บรรทัด)** — ตัวอย่างของตัวละครที่มีทรัพยากร 3 ชั้น (Interpretation บนศัตรู / Inspiration บนตัวเอง / Answer บนตัวเอง) และ AI ที่ปรับจูนตามรูปแบบทีม · มี `//temp` (บรรทัด 6) ส่วน AI ยังไม่นิ่ง
