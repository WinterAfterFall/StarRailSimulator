...
kit อ้างอิง: `docs/kit-reference/Character/Nihility/tingyun-fugue.md` · **ซัพพอร์ต Super Break** — คู่กับ `../Harmony/Harmony_MC.md` · เป็นที่เดียวที่เรียก `Toughness_break()` ด้วยมือ
