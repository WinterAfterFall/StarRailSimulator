...
kit อ้างอิง: `docs/kit-reference/Character/Nihility/cipher.md` · **ไฟล์ที่ใช้ True DMG (`Cal_DamageNote`) หนักที่สุดในโปรเจกต์** — ดาเมจหลักของตัวละครนี้คือ True DMG ที่แปะจากดาเมจของทั้งทีม
