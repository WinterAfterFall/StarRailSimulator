...
kit อ้างอิง: `docs/character-kit-reference/Black Swan.md` · **ไฟล์อ้างอิงหลักของระบบ DoT** — ใครจะทำตัวละคร DoT ให้เริ่มอ่านที่นี่ (`Black SwanV1.h` เป็นเวอร์ชันเก่า ข้าม)
