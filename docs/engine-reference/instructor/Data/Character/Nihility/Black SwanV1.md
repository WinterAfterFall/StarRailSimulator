...
`docs/character-kit-reference/README.md` ระบุไว้ว่า "ข้าม V1 dupes — ดูไฟล์ตัวจริงแทน" และ `character-kit-reference/Black Swan.md` ก็เขียนว่า "(เวอร์ชันเก่า `Black SwanV1.h` — ข้าม)"
