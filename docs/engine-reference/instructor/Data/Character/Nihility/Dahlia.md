...
kit อ้างอิง: `docs/character-kit-reference/Dahlia.md` · **ซัพพอร์ต Super Break ที่แก้ toughness reduction ของ action คนอื่นโดยตรง** · เป็นที่เดียวที่ใช้ `WeaknessApply_List` และตั้ง global `DahliaCheck`
