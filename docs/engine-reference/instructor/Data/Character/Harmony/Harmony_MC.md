...
kit อ้างอิง: `docs/character-kit-reference/Harmony_MC.md` · namespace `HarmonyMC` · **ซัพพอร์ต Super Break** — เป็นแหล่ง Super Break ให้ทั้งทีม ไม่ใช่แค่ตัวเอง (ต่างจาก `../Destruction/FireFly.md` และ `../Erudition/Rappa.md`)
