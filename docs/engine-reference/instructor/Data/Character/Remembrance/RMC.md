...
kit อ้างอิง: `docs/kit-reference/Character/Remembrance/trailblazer-remembrance.md` · **ไฟล์อ้างอิงหลักของระบบ memosprite** — ใครจะทำตัวละคร Remembrance ให้เริ่มที่นี่ · มี `//temp` (บรรทัด 5)
