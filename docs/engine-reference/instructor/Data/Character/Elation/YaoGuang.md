...
kit อ้างอิง: `docs/kit-reference/Character/Elation/yao-guang.md` · `Atv_stats->Name` = `"Yao Guang"` (มีช่องว่าง ต่างจากชื่อ namespace) · **ซัพพอร์ตสาย Elation** — อ่าน `Hibana.md` ก่อนสำหรับคำศัพท์ของ path นี้
