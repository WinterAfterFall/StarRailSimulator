...
> **`superimpose` ที่ส่งเข้ามาคือ "จำนวนชั้นที่เกินจาก S1"** ไม่ใช่เลข S เต็ม — ดูได้จากสูตร เช่น `DDD` ให้ `14 + 2*superimpose` ซึ่ง S1 = 14% (superimpose = 0) และ S5 = 22% (superimpose = 4)
