...
1. **หัวไฟล์** — path ของไฟล์โค้ดเป็น `#` แล้วบรรทัดถัดมาอ้าง kit (`docs/kit-reference/Character/<ชื่อ>.md`) + ประโยคเดียวว่าไฟล์นี้เป็นตัวอย่างของอะไร หรือเตือนถ้ายังไม่เสร็จ
